...
If you still happen to be using `babel-plugin-dynamic-import-webpack` you should remove it because it is not compatible with this plugin. Newer versions of Webpack now understand dynamic imports so you don't need this older plugin in any case.
